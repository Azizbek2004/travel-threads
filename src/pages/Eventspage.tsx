          ...
          case 2: // My events
            if (currentUser) {
              ...
              eventData = eventData.filter(
                (event) => event.authorId === currentUser.uid
              );
            }
            break;
        }
    ...
    return (
      <Box sx={{ pb: 8 }}>
        ...
        >
          ...
          <MenuItem onClick={() => handleCategorySelect('adventure')}>
            Adventure
          </MenuItem>
          <MenuItem onClick={() => handleCategorySelect('nature')}>
            Nature
          </MenuItem>
          <MenuItem onClick={() => handleCategorySelect('workshop')}>
            Workshop
          </MenuItem>
          <MenuItem onClick={() => handleCategorySelect('meetup')}>
            Meetup
          </MenuItem>
          <MenuItem onClick={() => handleCategorySelect('festival')}>
            Festival
          </MenuItem>
          <MenuItem onClick={() => handleCategorySelect('concert')}>
            Concert
          </MenuItem>
